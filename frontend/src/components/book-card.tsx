...
type BookCardProps = Omit<React.HTMLAttributes<HTMLDivElement>, "onError"> & {
...
export function BookCard({
  ...
  return (
    <div className={cn("group", className)} {...props}>
      <Link to="/" href={`/books/${book.id}`}>
        <Card
          className={cn(
            `
              border-none shadow-none relative h-full overflow-hidden rounded-lg py-0 transition-all
